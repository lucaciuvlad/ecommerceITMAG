...
class Validation extends Database
{
    ...
    public function loginValidation()
    {
        ...
        $sql = "SELECT user_email, user_password, user_active_account FROM users WHERE user_email = ?";
